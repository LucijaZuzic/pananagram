<template>
   <div>
        <table class="description" width="100%" style='border-collapse: collapse'>
            <tr>
                <h1 class="description pagetitle">&#128145; Popis prijatelja</h1>
            <tr>
            <tr>
                <td>
                    ...
                    <div v-if="filteredusers.length">
                        <table style='width: 100%; border-collapse: collapse'>
                            ...
                            <tr class = "row" v-for='index in user_array' v-bind:key = index>
                                ...
                                <td title = "Prekinite prijateljstvo" style="cursor: pointer" :class="{even: index % 2 === 0, odd: index % 2 !== 0}" v-on:click="unfriend(filteredusers[page_length * page_number + index].username)">&#128148;</td>
                                <td title = "Blokirajte korisnika" style="cursor: pointer" :class="{even: index % 2 === 0, odd: index % 2 !== 0}" v-on:click="block(filteredusers[page_length * page_number + index].username)">&#128683;</td>
